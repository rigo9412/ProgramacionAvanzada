...
export default function Home() {
  ...
  return (
    <div className='flex-col bg-black items-center justify-center'>
      ...
      <div className="flex  items-center justify-center" >
        <ButtonAction title="AC" value="?" color="bg-slate-300" textColor="text-black" ></ButtonAction>
        <ButtonAction title={"+/-"} value="&" color="bg-slate-300" textColor="text-black"></ButtonAction>
        <ButtonAction title={"%"} value="%" color="bg-slate-300" textColor="text-black"></ButtonAction>
        <ButtonAction title={"/"} value="/" color="bg-orange-400"></ButtonAction>
      </div>
      ...
      <div className="flex   items-center justify-center" >
        ...
        <ButtonAction title={"X"} value="X" onClickAction={addOperator} color="bg-orange-400"></ButtonAction>
      ...
      <div  className="flex items-center justify-center" >
        ...
        <ButtonAction title={"."} value="." color="bg-zinc-500"></ButtonAction>
