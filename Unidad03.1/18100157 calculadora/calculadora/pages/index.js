...
export default function Home() {
  const [result,operator, addNumber, addOperator, calculateResult] = useMath()
  ...
  return (
    <div className='flex-col bg-black items-center justify-center'>
      ...
      <div className="flex  items-center justify-center" >
        ...
        <ButtonAction title={"+"} value="+" selected={operator} onClickAction={addOperator} color="bg-orange-400"></ButtonAction>
      </div>
      <div  className="flex items-center justify-center" >
